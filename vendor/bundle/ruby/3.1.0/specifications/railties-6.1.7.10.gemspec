# -*- encoding: utf-8 -*-
# stub: railties 6.1.7.10 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/rails/rails/issues", "changelog_uri" => "https://github.com/rails/rails/blob/v6.1.7.10/railties/CHANGELOG.md", "documentation_uri" => "https://api.rubyonrails.org/v6.1.7.10/", "mailing_list_uri" => "https://discuss.rubyonrails.org/c/rubyonrails-talk", "rubygems_mfa_required" => "true", "source_code_uri" => "https://github.com/rails/rails/tree/v6.1.7.10/railties" } if s.respond_to? :metadata=
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<actionview>.freeze, ["= 6.1.7.10"])
  else
